	...
	controls.domElement.removeEventListener( 'pointerdown', _pointerdown );
	controls.domElement.removeEventListener( 'pointermove', _pointermove );
	...
	　　if(controls.object.position.y !== 250)
	  {
	 	...
	 	console.log(controls.object.ratate);
